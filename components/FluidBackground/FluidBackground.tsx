...
export default function FluidBackground() {
  ...
  useEffect(() => {
    webGLFluidEnhanced.config({
      ...
      DYE_RESOLUTION: 2048, // Resolution of the dye grid
      ...
      CURL: 20, // Curl value used in the simulation
      ...
      BLOOM_INTENSITY: 0.2, // Intensity of the bloom effect
      BLOOM_THRESHOLD: 0.5, // Threshold for the bloom effect
      BLOOM_SOFT_KNEE: 0.5, // Soft knee value for the bloom effect
      SUNRAYS: true, // Enables sunrays effect
      SUNRAYS_RESOLUTION: 196, // Resolution of the sunrays effect
      SUNRAYS_WEIGHT: 0.5, // Weight of the sunrays effect
    });
